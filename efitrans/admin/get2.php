...
$query = "SELECT * FROM ofertas_v WHERE tipo = '2' AND envia = '".$_SESSION['nick_act']."' ORDER by fecha DESC";
...
?>
	<div id="datos-chat" class="card" style="border-radius: 5%;">
        ...
        <span style="color: red; text-align: center;"><b> Oferta Rechazada Por <?php echo $row['recibe']; ?></b></span></div>
