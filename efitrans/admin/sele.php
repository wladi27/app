...
if (!isset($_SESSION['nick_act'])) {
    ...
    if (isset($_GET['id'])) {
        $id = $_GET['id'];
    $query = "SELECT * FROM v_largo WHERE id= $id";
...
<div class="pt-4">
		<div class="card" style="background: transparent; border: transparent;">
            ...
            <center><h6>Datos de Publicación</h6></center>
                <span style="color: #1C62C4; margin-left: 10px;"><b>Pedido de: <?php echo $row['nick']; ?></b></span>
        </div>
        <div class="card-body">
...
<?php
  if (isset($_POST['acepto'])) {
    ...
    $query = "SELECT * FROM user where nick = '".$_SESSION['nick_act']."'";
		...
		$sql = $mysqli->query("INSERT INTO ofertas_v (recibe, id, envia, tipo, d1, d2, date, time, tarifa, monto, fecha) VALUES ('$r','$i', '$e', '0', '$d1', '$d2', '$date', '$hp', '$tari', '$m', '$fecha')");
