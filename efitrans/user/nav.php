...
$query = "SELECT * FROM ofertas WHERE tipo = '0' AND recibe = '".$_SESSION['nick_act']."'";
$ejecutar = $mysqli->query($query);
$numero = $ejecutar->num_rows;

while($fila = $ejecutar->fetch_array()) ;

$query = "SELECT * FROM ofertas_v WHERE tipo = '0' AND recibe = '".$_SESSION['nick_act']."'";
$ejecutar = $mysqli->query($query);
$numero2 = $ejecutar->num_rows;


while($fila = $ejecutar->fetch_array()) ;
$numero_t = $numero+$numero2;
?>
<?php
...
<a  href="r_chat.php" class="navbar-link">
<span style="padding: 2px 7px; background: #f21; border-radius: 50%; color: white;" class=" position-absolute label label-success "><b><?php echo $numero_t;?></b></span>
...
<path fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z"/>
    ...
    <li class="nav-item">
      <h5><a class="nav-link" href="r_chat.php">
