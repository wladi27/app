...
if (!isset($_SESSION['nick_act'])) {
	...
	$query = "SELECT * FROM ofertas WHERE tipo = '1' AND envia = '".$_SESSION['nick_act']."' ORDER by fecha DESC";
...
?>
	<div id="datos-chat" class="card" style="border-radius: 5%;">
        ...
        <span style="color: #1C62C4; text-align: center;"><b> Oferta Aceptada Por <?php echo $fila['recibe']; ?></b></span>
        </div>
        <div class="card-body">
        ...
        <form class="pt-1" action="conta-c.php?id=<?php echo $fila['id']; ?>" method="post">
